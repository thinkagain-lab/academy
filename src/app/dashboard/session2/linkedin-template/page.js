...
The Session 2 at the Think Again Lab Python Bootcamp was packed with coding goodness! 😎

We explored: ✅ Numbers, Strings & Booleans
✅ Arithmetic operations like +, -, *, /, %, ** and more
✅ Fun string hacks (yes, we made Batman say “Na Na Na Na…” 🎵)
✅ Boolean logic that makes coding feel like solving mysteries 🕵️‍♂️
✅ A mini “Code Puzzle Challenge” that made our brains sweat (in the best way!) 🧠🔥

📍 Real takeaway? Python is not just powerful — it’s playful too!
💬 Example: "Na" * 5 + " Batman!" → You’ll never forget this one!

Big thanks to our mentors for making learning this fun and interactive 👏
And we even earned our first badge: 🏅 Data Dynamo!

💻 Built everything on Google Colab — zero installations, max productivity!
...
#Python #MachineLearning #BootcampJourney #ThinkAgainLab #ThinkAgainAcademy #LearningByDoing #9PMPOST #AI #RobotManOfIndia`;
  ...
  const handleBackToDashboard = () => {
    router.push('/dashboard/session2');
  };
        ...
        <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl p-8 mb-6">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-300">Session 2: Working with Python Data Types</p>
            </div>
          </div>
